          ...
          <div className="navbar bg-muted-lt">
            <div className="container-xl">
              <ul className="navbar-nav">
                ...
                {hasAnyPermission(["tamu"]) && (
                  <li
                    className={`nav-item ${
                      location.pathname === "/tamu" ? "active" : ""
                    }`}
                  >
                    <Link className="nav-link" to="/tamu">
                      <span className="nav-link-icon d-md-none d-lg-inline-block">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                      ...
                      <span className="nav-link-title">Tamu</span>
                    </Link>
                  </li>
                )}

                {hasAnyPermission(["absensi_staff"]) && (
                  <li
                    className={`nav-item ${
                  ...
                  >
                    <Link className="nav-link" to="/absensi">
                      ...
                      <span className="nav-link-title">Absensi Staff</span>
                    </Link>
                  </li>
                )}

                {(hasAnyPermission(["kategori_kunjungan"]) ||
